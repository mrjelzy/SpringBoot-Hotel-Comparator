...
public class AgencyData {
	...
	public CommandLineRunner InitDatabase(AgencyRepository aRepository, HotelRepository hRepository,
		...
		Agency agence = new Agency("Travel For Life", "travel", "travel", 0.12);
		aRepository.save(agence);

		Hotel h1 = new Hotel(1, "Le Ritz", "blanana", "Paris", "France", 5, "http://localhost:8080/hotelservice/ritz");
		Hotel h2 = new Hotel(2, "Le Negresco", "37 Promenade des Anglais", "Nice", "France", 5,
				"http://localhost:8084/hotelservice/negresco");
