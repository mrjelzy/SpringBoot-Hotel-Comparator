...
public class HotelData {
	...
	public CommandLineRunner InitDatabase(HotelRepository hRepository, AgencyRepository aRepository, BookingRepository bRepository, ClientRepository cRepository,
		...
		Hotel h1 = new Hotel("Pullmlan", "1 Rue des Pertuisanes", "Montpellier", "France", 4);
		hRepository.save(h1);
		
		Agency a1 = new Agency("Tour", "tour", "tour", 0.3);
		Agency a2 = new Agency("Smart Travel", "smart", "smart", 0.17);
		aRepository.save(a1);
		aRepository.save(a2);
		...
		Room r1 = new Room(4, 1260.36, "https://t-cf.bstatic.com/xdata/images/hotel/max1280x900/409940770.jpg?k=76b6a62e229eea3cd9ed279e1f23a6cd8d7a6e76849fd59b5eef406a95706f78&o=&hp=1");
		Room r2 = new Room(6, 1689.36, "https://t-cf.bstatic.com/xdata/images/hotel/max1280x900/206967994.jpg?k=e90201be923b9965459323e977530f066fcaed85f7f89e9d1f7f8b66a2b756a4&o=&hp=1");
		Room r3 = new Room(2, 1456.25, "https://t-cf.bstatic.com/xdata/images/hotel/max1280x900/366419089.jpg?k=39a1c650c952795135ac0866cb97ed3096e08837e6e576682a2874bc3a45f201&o=&hp=1");
		Room r4 = new Room(1, 1483.69, "https://t-cf.bstatic.com/xdata/images/hotel/max1280x900/156333415.jpg?k=77dcf931d3673448a39e9ce378f57c4d056f1639645759bc46661c038271f63e&o=&hp=1");
		rRepository.save(r1);
		rRepository.save(r2);
		rRepository.save(r3);
		rRepository.save(r4);
